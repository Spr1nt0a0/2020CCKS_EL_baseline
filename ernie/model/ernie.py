...
class ErnieConfig(object):
    ...
    def _parse(self, config_path):
        try:
            ...
            raise IOError(
                "Error in parsing Ernie model config file '%s'" %
                config_path,
            )
        else:
            return config_dict
...
class ErnieModel(object):
    ...
    def __init__(
        ...
        self._build_model(
            src_ids, position_ids, sentence_ids, task_ids,
            input_mask,
        )

    def _build_model(
        self, src_ids, position_ids, sentence_ids, task_ids,
        input_mask,
    ):
