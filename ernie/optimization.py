...
from utils.fp16 import apply_dynamic_loss_scaling
from utils.fp16 import create_master_params_grads
from utils.fp16 import master_param_to_train_param
...
def optimization(
    ...
    if use_fp16:
        ...
        master_param_to_train_param(
            master_param_grads, param_grads,
            train_program,
        )
