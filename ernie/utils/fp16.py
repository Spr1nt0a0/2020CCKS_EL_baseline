...
def apply_dynamic_loss_scaling(
    loss_scaling, master_params_grads,
    ...
    update_loss_scaling(
        is_overall_finite, loss_scaling, _num_good_steps,
...
def create_master_params_grads(
...
def update_loss_scaling(
    is_overall_finite, prev_loss_scaling, num_good_steps,
        ...
        with switch.default():
            ...
            with fluid.layers.Switch() as switch3:
                with switch3.case(should_decr_loss_scaling):
                    ...
                    less_than_one = fluid.layers.less_than(
                        new_loss_scaling,
                        static_loss_scaling,
                    )
