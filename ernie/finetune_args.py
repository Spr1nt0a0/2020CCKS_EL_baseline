...
model_g.add_arg(
    "init_pretraining_params", str, "/home/baochen/competition/ccs2020_EL/pretrained_model/ERNIE_1.0_max-len-512/params",
    "Init pre-training params which preforms fine-tuning from. If the "
    "arg 'init_checkpoint' has been set, this argument wouldn't be valid.",
)
model_g.add_arg("checkpoints", str, "/home/baochen/competition/ccs2020_EL/checkpoints/", "Path to save checkpoints.")
...
train_g.add_arg(
    "lr_scheduler", str, "linear_warmup_decay",
...
train_g.add_arg(
    "init_loss_scaling", float, 102400,
    "Loss scaling factor for mixed precision training, only valid when use_fp16 is enabled.",
)

train_g.add_arg("test_save", str, "./checkpoints/test_result", "test_save")
train_g.add_arg("metric", str, "acc_and_f1", "metric")
train_g.add_arg(
    "incr_every_n_steps", int, 100,
...
data_g.add_arg(
    "tokenizer", str, "FullTokenizer",
    "ATTENTION: the INPUT must be splited by Word with blank while using SentencepieceTokenizer or \
                      WordsegTokenizer",
)
data_g.add_arg("train_set", str, "/home/baochen/competition/ccs2020_EL/data/generated/train.txt", "Path to training data.")
data_g.add_arg("test_set", str, None, "Path to test data.")
data_g.add_arg("dev_set", str, "/home/baochen/competition/ccs2020_EL/data/generated/dev.txt", "Path to validation data.")
...
data_g.add_arg("random_seed", int, 1, "Random seed.")
data_g.add_arg("label_map_config", str, "/home/baochen/competition/ccs2020_EL/data/generated/type_label_map.json", "label_map_path.")
...
data_g.add_arg(
    "chunk_scheme", type=str, default="IOB", choices=[
        "IO", "IOB", "IOE", "IOBES",
    ], help="chunk scheme",
)
...
run_type_g.add_arg(
    "use_multi_gpu_test", bool, True,
    "Whether to perform evaluation using multiple gpu cards",
)
run_type_g.add_arg(
    "metrics", bool, True,
    "Whether to perform evaluation on test data set.",
...
parser.add_argument(
    "--enable_ce", action='store_true',
    help="The flag indicating whether to run the task for continuous evaluation.",
)
# yapf: enable
